...
if(isset($_POST['register']))
{
    ...
    if($error==0)
    {
        $creat=mysqli_query($conn,"INSERT INTO `users`(`name`, `lastname`, `email`, `tele`, `gender`, `birthday`,`id_user`, `password`, `code_verif`) 
        VALUES ('$name','$lastname','$email','$tele','$gender','$birthday','$id_user','$password','$code_verif')");
        ...
        if($creat){
            ...
            $style = " <a href='http://localhost/anisss/Public/Html/verif.php?token=$code_verif'>confirm your email address</a>";
            $mail->Body  = $style;
